...
public class EventAggregateTests {
    ...
    {
        // Arrange
        EventRawLog firstEvent = this.Given_RawEvent_Is_Added("scsmbstgra", "12345", "STARTED",  "APPLICATION_LOG", 1491377495213L);
        EventRawLog secondEvent = this.Given_RawEvent_Is_Added("scsmbstgra", "12345", "FINISHED",  "APPLICATION_LOG", 1491377495218L);

        ArrayList<EventRawLog> eventRawLogs = new ArrayList<>();
    ...
    public void CreateEvents_Given_Events_Are_In_Logfile_Alert_Not_Set_When_Duration_Less_Than_4_Milliseconds()
    {
        // Arrange
        EventRawLog firstEvent = this.Given_RawEvent_Is_Added("scsmbstgra", "12345", "STARTED",  "APPLICATION_LOG", 1491377495213L);
        EventRawLog secondEvent = this.Given_RawEvent_Is_Added("scsmbstgra", "12345", "FINISHED",  "APPLICATION_LOG", 1491377495214L);
    ...
    private EventRawLog Given_RawEvent_Is_Added(
            String id,
            String host,
            String state,
            String type,
    ...
    {
        EventRawLog eventRawLog = new EventRawLog();
